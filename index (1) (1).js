var outsideClick = function (e) {
    ...
    if (!container.contains(e.target) && container.offsetParent(e.target).length !== 0 && container.contains(':visible')) {
 ...
 // == == == faq scripts == == == //
 document.querySelectorAll(".faqAcc .flexAccHead").click(function () {
    let AccHeadObj = $(this);
 ...
 function toggleCurrencyMoreData(elem) {
    ...
    if (currentstate == alternate) {
       document.querySelectorAll(".currencyDetail .bottomListing").css("display", "none");
       elem.innerHTML = toggleCurrencyMoreDataState;
    } else {
       document.querySelectorAll(".currencyDetail .bottomListing").css("display", "block");
       elem.innerHTML = alternate;
    }
 }
